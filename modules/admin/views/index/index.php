...
<head>
	...
	<!--[if lte IE 9]>
	<link rel="stylesheet" href="../../public/admin/assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
	<![endif]-->
...
<div class="main-container ace-save-state" id="main-container">
		...
		<ul class="nav nav-list">
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<li class="active">
						<a href="/admin/index/index2" target="iframe0">
							<i class="menu-icon fa fa-caret-right"></i>
							会员管理
						</a>
	...
	<script>
								...
								window.onresize = function () {
									var iframs = document.getElementsByClassName('q_iframe');
									for(let v of iframs) {
										setIframeHeight(v);
									}
								};
	</script>
	<iframe src="/admin/index/index2" onload="setIframeHeight(this);" id="iframe0"  name="iframe0" class="q_iframe"  width="100%" height="100%" frameborder="0">
	</iframe>
</div>
